...
const HeartEmoticon = ({ height }) => {
  return (
    <span style={{display:"inline-block",margin:0,padding:0,lineHeight:0,verticalAlign:"middle",height:"auto"}}>
      <img
        height={height}
        role="presentation"
